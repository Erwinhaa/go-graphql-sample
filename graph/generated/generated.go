...
type PostMutationResolver interface {
	Create(ctx context.Context, obj *model.PostMutation, input model.NewPost) (*model.Post, error)
}
type PostQueryResolver interface {
	Posts(ctx context.Context, obj *model.PostQuery) ([]*model.Post, error)
}
...
type Query {
    post: PostQuery! @goField(forceResolver: true)
}
...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPostMutation2ᚖmyappᚋgraphᚋmodelᚐPostMutation(ctx, field.Selections, res)
}
...
func (ec *executionContext) _PostQuery_posts(ctx context.Context, field graphql.CollectedField, obj *model.PostQuery) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.PostQuery().Posts(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPostQuery2ᚖmyappᚋgraphᚋmodelᚐPostQuery(ctx, field.Selections, res)
}
	...
	for i, field := range fields {
		...
		case "posts":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._PostQuery_posts(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) marshalNPostMutation2myappᚋgraphᚋmodelᚐPostMutation(ctx context.Context, sel ast.SelectionSet, v model.PostMutation) graphql.Marshaler {
	return ec._PostMutation(ctx, sel, &v)
}

func (ec *executionContext) marshalNPostMutation2ᚖmyappᚋgraphᚋmodelᚐPostMutation(ctx context.Context, sel ast.SelectionSet, v *model.PostMutation) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNPostQuery2myappᚋgraphᚋmodelᚐPostQuery(ctx context.Context, sel ast.SelectionSet, v model.PostQuery) graphql.Marshaler {
	return ec._PostQuery(ctx, sel, &v)
}

func (ec *executionContext) marshalNPostQuery2ᚖmyappᚋgraphᚋmodelᚐPostQuery(ctx context.Context, sel ast.SelectionSet, v *model.PostQuery) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
